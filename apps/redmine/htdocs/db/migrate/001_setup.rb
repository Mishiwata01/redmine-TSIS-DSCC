...
class Setup < ActiveRecord::Migration
  ...
  def self.up
    ...
    user = User.new :firstname => "Masaki Ishiwata",
                    :lastname => "Admin",
                    :mail => "ishiwata@hpe.com", :language => "ja",
                    :mail_notification => true,
                    :status => 1
    user.login = 'mishiwata'
    user.hashed_password = "dc6d9bda388201ce8f259b82839e41f71f68f12d"
    user.admin = true
    user.save
